...
Process: (Will add detailed description of whats happening)


<img width="518" height="691" alt="VertBed (1)" src="https://github.com/user-attachments/assets/ff05fc18-a8de-40bd-962d-5e3c53489546" />

Example Figure: Simulated bed elevation (m) three ways over the same Sør Rondane region: Bedmachine (a), Bedmap3 (b), and a Sequential Gaussian Simulation Realization (c). The grounding line can be seen (black). When everything is done this will include the final simulation and mass flux residual, so this is a place holder.
